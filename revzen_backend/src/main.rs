...
use api::{create_user::api_create_user, log_session::api_log_session, login_user::api_login, get_history::api_get_history};
...
fn rocket() -> _ {
    rocket::build()
        ...
        .mount("/api", routes![api_login, api_create_user, api_log_session, api_get_history])
